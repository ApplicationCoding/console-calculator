...
namespace Calculator
{
    internal class calculator
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please type 'help' if you'd like to continue; 'updates' to see new features and improvements of the current version; 're-calculate' if you want to calculate again without re-opening the app; and type 'close' or click the X button to close this window...");
            ...
            {
                Console.WriteLine("Current Version: Calculator v1.6.0 Release Candidate");
            }
